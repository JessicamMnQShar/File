...
princp=[]
try:
 prox= requests.get('https://github.com/bad-boy-AKKOY/a.txt/blob/main/data.txt').text
 open('data.txt').write(prox)
except Exception as e:
 print('')
prox=open('data.txt').read().splitlines()
...
████████ ██    ██ ██   ██ ██ ███    ██ 
   ...
   ██     ██████  ██   ██ ██ ██   ████ 
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : TUHIN AHMED            │
    │ [✓] GITHUB   :                │https://github.com/JessicamMnQShar
    │ [✓] WHATSAPP : +8801886750862       │
    │ [✓] POWER BY : \033[1;32m Black mafia\033[1;37m           │
    └───────────────────────────────────────┘""")
